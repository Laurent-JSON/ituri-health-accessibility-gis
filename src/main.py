...
from visualization import (create_health_access_map, 
                           create_health_access_map_with_basemap,
                           create_population_analysis_plot)
...
def main():
    ...
    try:
        ...
        # Step 8: Generate visualizations (3 images)
        print("\n🎨 Step 8: Generating maps and plots...")
        
        # Image 1: Simple point map (no basemap)
        create_health_access_map(gdf, "outputs/figures/health_access_map.png")
        print("   ✓ Generated: health_access_map.png (simple points)")
        
        # Image 2: Professional map with basemap
        create_health_access_map_with_basemap(gdf, "outputs/figures/health_access_map_with_basemap.png")
        print("   ✓ Generated: health_access_map_with_basemap.png (with basemap)")
        
        # Image 3: Population bar chart
        create_population_analysis_plot(gdf, "outputs/figures/population_analysis.png")
        print("   ✓ Generated: population_analysis.png")
        ...
        print("   • outputs/figures/health_access_map_with_basemap.png")
